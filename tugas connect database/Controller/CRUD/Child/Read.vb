Public Class Read
    ...
    Public Overloads Function view1where(c As String, b As String, a As String, z As String) As Boolean
        tabel = New DataTable
        Dim _query As String = "select " + c + " from " + b + " where " + a + "='" + z + "'"
        Try
            bool = False
            cmd_a = New MySql.Data.MySqlClient.MySqlDataAdapter(_query, openconnection())
            cmd_a.Fill(tabel)
            If tabel.Rows(0).Item(0) = z Then
                bool = True
            Else
                bool = False
            End If
