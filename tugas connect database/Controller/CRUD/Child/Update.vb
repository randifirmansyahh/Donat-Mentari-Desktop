...
Public Class Update
    ...
    Public Overloads Function pesanan(namaAsal As String, nama As String, jenis As String, banyak As String, total As Integer)
        'pesanan
        _query = "update pesanan set Nama=@nama,Jenis=@jenis,Banyak=@banyak,Total=@total where Nama='" + namaAsal + "'"
        Try
    ...
    Public Overloads Function pesanan(nama As String)
        'pesanan dikirim
        _query = "update pesanan set Status='Berhasil' where Nama='" + nama + "'"
        Try
            cmd_b = New MySql.Data.MySqlClient.MySqlCommand(_query, openconnection())
            cmd_b.Parameters.Add("@nama", MySql.Data.MySqlClient.MySqlDbType.VarChar).Value = nama
            cmd_b.ExecuteNonQuery()
