Public Class Create
    ...
    Public Function pesandonat(nama As String, jenis As String, banyak As Integer, total As Integer, tanggal As String) As String
        'pesandonat
        _query = "insert into pesanan values(@nama,@jenis,@banyak,@total,@tanggal,@status)"
        Try
            cmd_b = New MySql.Data.MySqlClient.MySqlCommand(_query, openconnection())
            cmd_b.Parameters.Add("@nama", MySql.Data.MySqlClient.MySqlDbType.VarChar).Value = nama.ToLower
            cmd_b.Parameters.Add("@jenis", MySql.Data.MySqlClient.MySqlDbType.VarChar).Value = jenis
            cmd_b.Parameters.Add("@banyak", MySql.Data.MySqlClient.MySqlDbType.Int32).Value = banyak
            cmd_b.Parameters.Add("@total", MySql.Data.MySqlClient.MySqlDbType.Int32).Value = total
            cmd_b.Parameters.Add("@tanggal", MySql.Data.MySqlClient.MySqlDbType.VarChar).Value = tanggal
            cmd_b.Parameters.Add("@status", MySql.Data.MySqlClient.MySqlDbType.VarChar).Value = "Dalam Proses"
            cmd_b.ExecuteNonQuery()
            MsgBox("Pemesanan Telah Dilakukan, Mohon Tunggu Informasi Selanjutnya dari Admin, Terima Kasih.", MsgBoxStyle.Information)
        Catch ex As Exception
            MsgBox("Failed")
        End Try
        Return str
    ...
    Public Overloads Function insertpasienordokter(ditangani As String, nama As String, alamat As String, agama As String, TTL As String, kedatangan As String, keluhan As String)
        ...
        Return bool
    End Function
    Public Overloads Function insertopereatororpetugas(divisi As String, nama As String, alamat As String, agama As String, TTL As String) As Boolean
        'petugas
        ...
        Try
            ...
            cmd_b.ExecuteNonQuery()
            bool = True
            MsgBox("Petugas Berhasil Ditambahkan", MsgBoxStyle.Information)
        Catch ex As Exception
