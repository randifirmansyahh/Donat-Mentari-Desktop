Public Class usermenu
    ...
    Private Sub menuuser_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        hidepopupkomentar()
        childalat.banyak = check.checkcount("berita")
        If childalat.banyak = "0" Then
            Label1.Hide()
        Else
            Label1.Text = childalat.banyak
        End If
    End Sub
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Dim b As New optampilberita("user")
        Me.Hide()
        b.Show()
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Me.Hide()
        Dim op As New TampPesanan("user")
        op.Show()
    End Sub
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        MsgBox("Terima kasih atas kunjungannya", MsgBoxStyle.Information)
        Me.Hide()
        With pengunjung
            .Show()
            .TextBox1.Clear()
