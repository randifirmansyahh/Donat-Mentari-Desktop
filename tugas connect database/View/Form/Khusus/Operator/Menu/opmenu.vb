Public Class opmenu
    ...
    Private Sub Button0_Click(sender As Object, e As EventArgs) Handles Button0.Click
        Me.Hide()
        Dim detail As New opdetail("op")
        detail.ShowDialog()
    End Sub

    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Me.Hide()
        Dim b As New optampilberita("op")
        b.ShowDialog()
    End Sub
    ...
    Private Sub Button8_Click(sender As Object, e As EventArgs) Handles Button8.Click
        Me.Hide()
        Dim a As New AllPesanan("op")
        a.ShowDialog()
    End Sub

    Private Sub Button1_Click_1(sender As Object, e As EventArgs)
        DataGridView2.DataSource = search.searchpasien("INP", "")
        If DataGridView2.RowCount < 1 Then
            MsgBox("Tambahkan pasien terlebih dahulu", MsgBoxStyle.Critical)
        Else
            Me.Hide()
    ...
    Private Sub Chart1_MouseHover(sender As Object, e As EventArgs) Handles Button11.MouseHover
        '93; 78
        chart()
        ...
        Chart1.BringToFront()
    End Sub
    Private Sub Chart1_MouseLeave(sender As Object, e As EventArgs) Handles Button11.MouseLeave
        '93; 78
    ...
    Private Sub chart()
        ...
        With Chart1
            ...
            .Series.Add("Berhasil")
            For i = 0 To 1
                .Series(i).ChartType = DataVisualization.Charting.SeriesChartType.Pyramid
            Next
            .Series(0).Points.AddXY(check.checkcountwhere("Banyak", "pesanan", "Dalam Proses", DateTimePicker1.Text) + " Pesanan", check.checkcountwhere("Banyak", "pesanan", "Dalam Proses", DateTimePicker1.Text))
            .Series(0).Points.AddXY(check.checkcountwhere("Banyak", "pesanan", "Berhasil", DateTimePicker1.Text) + " Berhasil", check.checkcountwhere("Banyak", "pesanan", "Berhasil", DateTimePicker1.Text))
        End With
    End Sub
