Public Class loadingawal
    ...
    Private Sub cektime()
        ...
        ElseIf ProgressBar1.Value = 25 Then
            ...
            aksiloading()
            Me.BackgroundImage = tugas_connect_database.My.Resources.Resources.donat1
        ElseIf Progressbar1.Value = 50 Then
            Label4.Text = childloadingfirst.kata(2)
            aksiloading()
            aksiloading()
            Me.BackgroundImage = tugas_connect_database.My.Resources.Resources.donat3
        ElseIf ProgressBar1.Value = 75 Then
            Label4.Text = childloadingfirst.kata(3)
            Me.BackgroundImage = tugas_connect_database.My.Resources.Resources.donat8
        End If
    End Sub
End Class